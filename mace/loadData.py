...
try:
  from mace._data_main.fair_adult_data import *
except:
  pass
  # print('[ENV WARNING] fair_adult_data not available')

try:
  from mace._data_main.fair_compas_data import *
except:
  pass
  # print('[ENV WARNING] fair_compas_data not available')

try:
  from mace._data_main.process_credit_data import *
except:
  pass
  # print('[ENV WARNING] process_credit_data not available')

try:
  from mace._data_main.process_german_data import *
except:
  pass
  # print('[ENV WARNING] process_german_data not available')

try:
  from mace._data_main.process_synthetic_data import *
except:
  pass
  # print('[ENV WARNING] process_synthetic_data not available')

try:
  from mace._data_main.process_mortgage_data import *
except:
  pass
  # print('[ENV WARNING] process_mortgage_data not available')

try:
  from mace._data_main.process_twomoon_data import *
except:
  pass
  # print('[ENV WARNING] process_twomoon_data not available')

try:
  from mace._data_main.process_test_data import *
except:
  pass
  # print('[ENV WARNING] process_test_data not available')

try:
  from mace._data_main.process_sba_data import *
except:
  pass
  # print('[ENV WARNING] process_sba_data not available')

try:
  from mace._data_main.process_student_data import *
except:
  pass
  # print('[ENV WARNING] process_student_data not available')
...
class Dataset(object):
  ...
  def getBalancedDataFrame(self):
    ...
    number_of_subsamples_in_each_class = min(unique_values_and_count[0], unique_values_and_count[1])
  ...
  # of data... weird.
  def getTrainTestSplit(self, preprocessing = None, with_meta = False, shift=False):
    ...
    if with_meta:
      ...
      if shift:                                                                                          
        X_shift, y_shift = np.concatenate((X_train, X_test), axis=0), np.concatenate((y_train, y_test), axis=0)                                                                                                 
...
def loadDataset(dataset_name, return_one_hot, load_from_cache = False, debug_flag = True, meta_param = None, shift=False):
  ...
  if dataset_name == 'adult':
    ...
    data_frame_non_hot = load_german_data_(shift=False) if not shift else load_german_data_(shift=True)
    data_frame_non_hot = data_frame_non_hot.reset_index(drop=True)                                     
    attributes_non_hot = {}                                                                            
    ...
    for col_idx, col_name in enumerate(input_cols):                                                                                                                                               
      if col_name == 'Status': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True                                                                              
        ...
        actionability = 'any'              
        mutability = True                  
      elif col_name == 'Installmemt rate': 
        attr_type = 'numeric-real'         
        # actionability = 'none'           
        actionability = 'any'              
        mutability = True                  
      elif col_name == 'Present residence':
        attr_type = 'numeric-int'          
        # actionability = 'none'           
        actionability = 'any'              
        mutability = True                  
    ...
    data_frame_non_hot = load_sba(shift=False) if not shift else load_sba(shift=True)
    data_frame_non_hot = data_frame_non_hot.reset_index(drop=True)                                     
    attributes_non_hot = {}                                                                            
    ...
    for col_idx, col_name in enumerate(input_cols):                                                                                                                                               
      if col_name == 'UrbanRural': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True
        ...
        actionability = 'any'                                                                          
        mutability = True  
      elif col_name == 'RealEstate': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True  
      elif col_name == 'Recession': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True                                                                               
      elif col_name == 'Term':                                                                     
        ...
        actionability = 'any'                                                                          
        mutability = True             
      elif col_name == 'ChgOffPrinGr':    
        attr_type = 'numeric-real'                    
        actionability = 'any'              
        mutability = True         
      elif col_name == 'GrAppv':    
        attr_type = 'numeric-real'                    
        actionability = 'any'              
        mutability = True
      elif col_name == 'SBA_Appv':    
        attr_type = 'numeric-real'                    
        actionability = 'any'              
        mutability = True 
      elif col_name == 'Portion':    
        attr_type = 'numeric-real'                    
        actionability = 'any'              
        mutability = True
      elif col_name == 'DisbursementGross':
        attr_type = 'numeric-real'
        actionability = 'any'
        mutability = True
    ...
    data_frame_non_hot = load_student(shift=False) if not shift else load_student(shift=True)
    data_frame_non_hot = data_frame_non_hot.reset_index(drop=True)
    attributes_non_hot = {}
    input_cols, output_col = getInputOutputColumns(data_frame_non_hot)
    ...
    for col_idx, col_name in enumerate(input_cols):
      if col_name == 'studytime': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                      
        mutability = True
      elif col_name == 'famsup': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True  
      elif col_name == 'higher': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True  
      elif col_name == 'internet': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True          
      elif col_name == 'health': # TODO: make sex and race immutable in all datasets!                    
        attr_type = 'categorical'                                                                      
        actionability = 'any'                                                                          
        mutability = True  
      elif col_name == 'age':                                                                     
        ...
        attr_type = 'numeric-real' # 'numeric-real'                                                     
        actionability = 'any'                                                                          
        mutability = True
      elif col_name == 'G2':                                                                     
        attr_type = 'numeric-real' # 'numeric-real'                                                     
    ...
    data_frame_non_hot = load_synthetic_data()
    data_frame_non_hot = data_frame_non_hot.reset_index(drop=True)
    attributes_non_hot = {}
